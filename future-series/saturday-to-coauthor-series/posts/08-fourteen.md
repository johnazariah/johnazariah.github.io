...
_Part 8 of From Saturday to Co-Author. [Part 7 covered the charge decomposition](/tags/from-saturday-to-coauthor/). This series is dedicated to [Stephen Jordan](https://scholar.google.com/citations?user=dcSsY4cAAAAJ&hl=en&oi=ao)._
...
The phase of the project this post covers, in the timeline of [Part 1](/tags/from-saturday-to-coauthor/), is the MaxCut follow-on (Phase 2), which began the day after the XORSAT paper was submitted on 27 April. It is the second half of the "two stories" the series is telling: the same engine, the same algebra, the same test harness, a different problem family, eight weeks later.

---

## The arithmetic of $p = 14$

The charge evaluator from [Part 7](/tags/from-saturday-to-coauthor/) is $O(p \cdot 4^p)$. Forward cost roughly quadruples for each unit of $p$ added. The manual charge adjoint is roughly $4.5 \times$ forward, independent of $p$. By the standards of where the project started, that is enormously generous: $p = 14$ should take about eight or nine hours of wall clock on a workstation. The wall clock is not the constraint.
