---
    ...
    author: johnazariah
    summary: Part 10 of the project report. The two bookend screenshots, the ten innovations and where they came from, and the case that programming languages are research tools, not just implementation tools.
---
...
This post is what the eight weeks were really about, with the screenshots that mark the beginning and the end.

---

## Saturday, 21 March, 03:47

[Screenshot of Stephen's 21 March 03:47 email: "The problem I have in mind..." through the bottom of the visible baseline table. Placeholder: `assets/images/2026-XX-XX-from-saturday-to-coauthor-10/email-sat21-bookend-open.png`.]
...
[Screenshot of Stephen's 28 March 08:06 email: "I think the most likely course of action is to weave your numbers into the attached paper and include you as a coauthor..." through "are very reassuring." Placeholder: `assets/images/2026-XX-XX-from-saturday-to-coauthor-10/email-sat28-bookend-close.png`.]
...
The two screenshots above are, by themselves, the entire arc this series is reporting. The middle eight posts are how the second screenshot followed from the first.
