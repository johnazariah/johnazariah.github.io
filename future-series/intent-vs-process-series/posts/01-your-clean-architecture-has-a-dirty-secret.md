---
    layout: post
    title: "Your Clean Architecture Has a Dirty Secret"
...
>
> This is Part 1 of a 5-part series on separating intent from process in real-world C#.
>
...
> **Next**: [The Algebra of Intent](/2026/03/06/the-algebra-of-intent.html) — where we find that C# developers have been *almost* doing this for years with interfaces and DI, and we show what it looks like to do it properly.
