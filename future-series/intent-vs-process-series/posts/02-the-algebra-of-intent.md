...
>
> This is Part 2 of a 5-part series on separating intent from process in real-world C#.
>
...
> **Next**: [Intent You Can See (and Optimize)](/2026/03/07/intent-you-can-see-and-optimize.html) — where we make programs inspectable and discover that programs-as-data unlock batching, deduplication, cost estimation, and a saga pattern that writes itself.
